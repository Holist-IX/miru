...
// PREPROCESSOR-REMOVE-END
	...
	mxClient.include(mxClient.basePath+'/js/miru/ixpapi.js');
	mxClient.include(mxClient.basePath+'/js/miru/js-yaml.js');
	mxClient.include(mxClient.basePath+'/js/miru/docker.js');
